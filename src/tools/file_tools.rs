        ...
        for op in params.operations {
            match op.operation.as_str() {
                "replace" => {
                    let search = op
                        .search
                        .ok_or_else(|| anyhow::anyhow!("search required for replace"))?;
                    let replace = op
                        .replace
                        .ok_or_else(|| anyhow::anyhow!("replace required for replace"))?;
                ...
                "insert" => {
                    let line = op
                        .line
                        .ok_or_else(|| anyhow::anyhow!("line required for insert"))?;
                    let content = op
                        .content
                        .ok_or_else(|| anyhow::anyhow!("content required for insert"))?;
                ...
                "delete" => {
                    let start = op
                        .start_line
                        .ok_or_else(|| anyhow::anyhow!("start_line required for delete"))?;
                    let end = op
                        .end_line
                        .ok_or_else(|| anyhow::anyhow!("end_line required for delete"))?;
